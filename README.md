...
- **[std](./skills/productivity/std/SKILL.md)** — Rewrite prose (docs, READMEs, PR text, error messages — never code) into ASD-STE100 Simplified Technical English to remove AI slop.
